    ...
    public class CrystalSpray_Proj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(Main.rand.NextBool(16))
            {
                ...
                GlowDustHelper.DrawGlowDustPerfect(Projectile.Center + new Vector2(8, 8), ModContent.DustType<Dusts.GlowDusts.GlowCircleFlare>(), (Projectile.velocity), Color.CornflowerBlue, Main.rand.NextFloat(.8f, .9f), dustShader);
            }
            else
            {
                Dust d = Dust.NewDustDirect(Projectile.Center, 1, 1, Main.rand.Next(new int[] { DustID.DungeonWater, DustID.SpectreStaff }));
